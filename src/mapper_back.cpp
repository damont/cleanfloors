...
void Mapper_back::move_and_update(Mapper_info& m_info, int32_t num_steps, State state)
{
...
void Mapper_back::update_current(Mapper_info& m_info, State state)
{

}

void Mapper_back::update_front(Mapper_info& m_info, State state)
{
...
int32_t Mapper_back::next_object(Mapper_info& m_info)
{
...
void Mapper_back::move(Mapper_info& m_info, int32_t num_steps)
{
	// Just add the steps in the x position.
	m_info.m_y = m_info.m_y - num_steps;
}
